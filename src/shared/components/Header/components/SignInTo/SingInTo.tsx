        ...
        <div className={s.singInTo}>
          ...
          {registerResult === false && <Text className={s.errorText}>Check the entered data</Text>}
           <Button
            className={s.singInTo__button}
            onClick={async () => {
              await logIn.fetchRecipes({ username: loginRegister, email: email, password: passwordRegister });
              setRegisterResult(logIn.isResult);
            }}
          >
            Register
          </Button>
          {registerResult === true && <Text className={s.errorText}>Registration was successful, log in</Text>}
           <Button
            className={s.singInTo__button}
            onClick={() => {
              setRegister(false);
